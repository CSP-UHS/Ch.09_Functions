...
def draw_BB8(x,y, radius):
    ...
    arcade.draw_circle_filled(x, y, radius, arcade.color.BLACK,3)

    arcade.draw_circle_filled(x,y,radius/1.5,arcade.color.ORANGE)
    arcade.draw_circle_filled(x, y, radius/1.5, arcade.color.BLACK,3)

    arcade.draw_circle_filled(x,y,radius/3,arcade.color.LIGHT_STEEL_BLUE)
    arcade.draw_circle_filled(x, y, radius/3, arcade.color.BLACK,3)
    ...
    """# Draw Eye"""
    arcade.draw_circle_filled(x,y+1.2*radius,radius/3,arcade.color.LIGHT_STEEL_BLUE)
    arcade.draw_circle_filled(x, y+1.2*radius/5, arcade.color.BLACK,3)
